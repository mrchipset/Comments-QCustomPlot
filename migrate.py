...
header_list = [
    'global.h', 'vector2d.h', 'painter.h', 'paintbuffer.h', 'layer.h',
    'axis/range.h', 'selection.h', 'selectionrect.h', 'layout.h',
    'lineending.h', 'axis/axisticker.h', 'axis/axistickerdatetime.h',
    'axis/axistickertime.h', 'axis/axistickerfixed.h', 'axis/axistickertext.h',
    'axis/axistickerpi.h', 'axis/axistickerlog.h', 'axis/axis.h',
    'scatterstyle.h', 'datacontainer.h', 'plottable.h', 'item.h', 'core.h',
    'plottable1d.h', 'colorgradient.h', 'selectiondecorator-bracket.h',
    ...
    'plottables/plottable-graph.h', 'plottables/plottable-curve.h',
    'plottables/plottable-bars.h', 'plottables/plottable-statisticalbox.h',
    'plottables/plottable-colormap.h', 'plottables/plottable-financial.h',
    'plottables/plottable-errorbar.h', 'items/item-straightline.h',
    'items/item-line.h', 'items/item-curve.h', 'items/item-rect.h',
    'items/item-text.h', 'items/item-ellipse.h', 'items/item-pixmap.h',
    'items/item-tracer.h', 'items/item-bracket.h'
]
...
with open('LarkPlot/qcustomplot.h', 'w') as f:
    f.write('''
...
with open('LarkPlot/qcustomplot.cpp', 'w') as f:
    f.write('''
